      ...
      <div className="relative flex h-screen flex-col bg-light-100 px-4 pt-4 dark:bg-dark-50">
        ...
        <div className="flex h-[54px] items-center justify-center">
          ...
          {!IS_CLOUD && !HIDE_POWERED_BY && (
            <span
              className="absolute right-[1rem] inline-flex items-center gap-[0.175rem] rounded-full border border-light-300 bg-light-50 px-3 py-1 text-[11px] font-medium text-light-950 shadow-sm dark:border-dark-300 dark:bg-dark-50 dark:text-dark-900"
            >
              <span>{`Powered by`}</span>
              <span className="font-semibold">Orello</span>
            </span>
          )}
        </div>
      </div>
